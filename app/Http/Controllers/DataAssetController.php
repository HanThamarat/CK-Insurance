...
class DataAssetController extends Controller
{
        ...
        public function updateAssetData(Request $request)
        {
            ...
            if ($asset) {
                ...
                $asset->Vehicle_Brand = $request->input('vehicle_brand');
                $asset->Vehicle_Group = $request->input('vehicle_group');
                $asset->Vehicle_Years = $request->input('vehicle_years');
                $asset->Vehicle_Models = $request->input('vehicle_models');
                $asset->Vehicle_Gear = $request->input('vehicle_gear');
