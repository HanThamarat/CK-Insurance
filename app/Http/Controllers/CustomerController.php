...
class CustomerController extends Controller
{
    ...
    {
        // Prepare the data with formatted dates (without validation)
        $data = [
            ...
            'expiry_date' => formatDate($request->input('expiry_date')), // แปลงวันที่ด้วยฟังก์ชันจาก Helper
            'dob' => formatDate($request->input('dob')), // แปลงวันที่ด้วยฟังก์ชันจาก Helper
        ];
