...
class DataCusAddressController extends Controller
{
    ...
    public function updateAddress(Request $request)
    {
        ...
        $address->update($request->only([
            'DataCus_id', 'Registration_number', 'date_Adds', 'Code_Adds', 'Ordinal_Adds', 'Status_Adds',
            'Type_Adds', 'houseNumber_Adds', 'houseGroup_Adds', 'building_Adds', 'village_Adds',
            'roomNumber_Adds', 'Floor_Adds', 'alley_Adds', 'road_Adds', 'houseZone_Adds',
            'houseProvince_Adds', 'houseDistrict_Adds', 'houseTambon_Adds', 'Postal_Adds',
            'Detail_Adds', 'Coordinates_Adds', 'UserZone', 'UserBranch', 'UserInsert', 'UserUpdate'
        ]));

        // ส่งข้อความยืนยันการอัปเดต โดยไม่ต้องส่งข้อมูลทั้งหมด
