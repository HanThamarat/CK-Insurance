...
{{-- <div id="edit_modal_asset"
    ...
    <div class="relative bg-white rounded-lg w-full max-w-screen-lg  max-h-screen overflow-auto scrollbar-hidden mt-12 mb-12"
        ...
        <div class="">
            ...
            <!-- Body -->
            <form action="editAssetForm" onsubmit="return false;">
                @csrf
                <div class="p-8">
...
{{-- // $.ajax({
    ...
    //     },
    //     success: function(data) {
    //         // ฟังก์ชันแปลงวันที่เป็น วัน เดือน ปี แบบไทย
    ...
    //         // ใช้ฟังก์ชัน formatDateThai เพื่อแสดงวัน เดือน ปี แบบไทย
    //         $('#edit_Insurance_renewal_date').val(formatDateThai(data.Insurance_renewal_date));
    //         $('#edit_Insurance_end_date').val(formatDateThai(data.Insurance_end_date));
    //         $('#edit_act_renewal_date').val(formatDateThai(data.act_renewal_date));
    //         $('#edit_act_end_date').val(formatDateThai(data.act_end_date));
    //         $('#edit_register_renewal_date').val(formatDateThai(data.register_renewal_date));
    //         $('#edit_register_end_date').val(formatDateThai(data.register_end_date));
    //         $('#edit_Vehicle_InsuranceStatus').val(data.insurance_status);
    //         $('#edit_Vehicle_Companies').val(data.insurance_company);
    //         $('#edit_Vehicle_PolicyNumber').val(data.policy_number);
    //         $('#edit_Vehicle_New_Number').val(data.Vehicle_New_Number);

    //         // แสดงวันที่สร้างและแก้ไขล่าสุดในรูปแบบไทย
    //         $('#edit_created_at').text(formatDateThai(data.created_at));
    //         $('#edit_updated_at').text(formatDateThai(data.updated_at));
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-blue-50 rounded-xl p-6 shadow-sm border border-blue-100">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="form-group">
                                    <label class="text-gray-600 block mb-1">ประเภทรถ 1</label>
                                    <select id="edit_Vehicle_Type" name="Vehicle_Type" class="w-full border-gray-300 rounded-lg px-3 py-2">
