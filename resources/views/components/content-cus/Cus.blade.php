                    ...
                    <div class="p-8">
                        <div class="flex items-center space-x-4 mb-8">
                            <div class="w-16 h-16 rounded-full bg-orange-100 flex items-center justify-center">
                                <img src="{{ asset('img/user.gif') }}" alt="career icon"
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                            ...
                                            <div class="relative">
                                                ...
                                                <i
                                                    class="fa-brands fa-line absolute right-3 top-3 text-green-600 text-md"></i>
                                            </div>
                                    ...
                                    <div class="space-y-4">
                                        <div class="relative">
                                            <select id="marital_status" name="marital_status"
                                                onfocus="moveLabel('marital_status')"
                                                onblur="checkInput('marital_status')"
                                                class="p-2 border border-gray-300 rounded-lg text-sm w-full focus:outline-none focus:border-orange-600 focus:ring-0 text-gray-500">
