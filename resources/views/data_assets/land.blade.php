        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="landModalLabel">ที่ดิน</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <img src="{{ asset('images/land.png') }}" alt="Profile Image" class="img-fluid">
            ...
            <div class="modal-body">
                <div class="d-flex m-3 mb-0">
                    <div class="flex-shrink-0 me-2">
                        <img src="{{ asset('images/land.png') }}" alt="" class="avatar-sm"
                ...
                <form>
                    <div class="col-xl-12">
                        ...
                        <p class="fw-bold bg-opacity-20 border-start ps-1 mt-2">
                            <i class="fas fa-map-marker-alt"></i> ข้อมูลที่ดิน
                        </p>

                        <input type="hidden" name="id" id="form_id" value="">
                        <input type="hidden" name="assetold_id" id="assetold_id" value="">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row gx-4 mb-3">
                                        <!-- Form Group (first name) -->
                                        <div class="col-md-4 mb-3">
                                            <input class="form-control border-warning border rounded"
                                                id="inputFirstName" type="text" placeholder="อักษร/คำ"
                                                value="">
                                        </div>
                                        <!-- Form Group (last name) -->
                                        <div class="col-md-4 mb-3">
                                            <input class="form-control border-warning border rounded"
                                                id="inputLastName" type="text" placeholder="ตัวเลข"
                                                value="">
                                        </div>
                    ...
                    <div class="row gx-4 mb-3">
                        ...
                        <div class="col-md-4">
                            <input class="form-control border-warning border rounded" id="inputOrgName"
                                type="text" placeholder="เลขถัง" value="">
                        </div>

                        <div class="col-md-3">
                            <input class="form-check-input border-warning" id="inputOrgName" type="checkbox"
                                value="">
                            <label class="form-check-label border-warning"
                                for="inputOrgName">มีกำหนดตอกเลขตัวรถใหม่</label>
                        </div>

                        <div class="col-md-5">
                            <input class="form-control border-warning border rounded" id="inputNewCarNumber"
                                type="text" placeholder="เลขตัวรถใหม่" value="" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row gx-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <input class="form-control border-warning border rounded" id="inputFirstName"
                                type="text" placeholder="เลขเครื่อง" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-4 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="สีรถ" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-4 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="CC" value="">
                        </div>
                    </div>
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="datetime-local" class="border-warning border rounded" id="date"
                                placeholder="วันครอบครองล่าสุด" name="date">
                        </div>
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        <div class="col-md-4 mb-3">
                            <input class="form-control border-warning border rounded" id="inputFirstName"
                                type="text" placeholder="เลขไมล์" value="">
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mt-0 border-top">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="row g-2 align-self-center">
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="input-bx mt-2">
                                        <input type="text" class="form-control border-warning border rounded"
                                            id="PolicyNumber" name="PolicyNumber" value="" autocomplete="off"
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="row g-2 align-self-center">
                                ...
                                <div class="col-12 mb-0 ">
                                    <div class="input-bx">
                                        <select class="form-select PurposeType border-warning" id="PurposeType"
                                            name="PurposeType" data-bs-toggle="tooltip">
                                ...
                                <div class="col-12 mb-0">
                                    <div class="input-bx mt-2">
                                        <select class="form-select border-warning PossessionOrder"
                                            id="PossessionOrder" name="PossessionOrder" data-bs-toggle="tooltip">
                                ...
                                <div class="col-12 mb-0">
                                    <div class="input-bx mt-2">
                                        <select class="form-select History_16 border-warning" id="History_16"
                                            name="History_16" data-bs-toggle="tooltip">
                                ...
                                <div class="col-12 mb-0">
                                    <div class="input-bx mt-2">
                                        <select class="form-select History_18 border-warning" id="History_18"
                                            name="History_18" data-bs-toggle="tooltip">
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputFirstName"
                                type="text" placeholder="ราคากลาง" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ราคาทุน" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ภาษี" value="">
                        </div>

                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="รวมมูลค่าสินค้า" value="">
                        </div>
                    </div>
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        <!-- Form Group (first name) -->
                        <div class="col-md-3 mb-3">
                            <select class="form-select border-warning border rounded" id="inputFirstName"
                                name="status">
                        ...
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ค่าขนส่ง" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ต้นทุนรวมภาษี" value="">
                        </div>

                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="รวมภาษีมูลค่าเพิ่ม" value="">
                        </div>
                    </div>
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="อัตราภาษี" value="">
                        </div>
                        <!-- Form Group (last name) -->
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ค่าอื่น ๆ" value="">
                        </div>

                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="ราคาขาย" value="">
                        </div>

                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="รวมราคาสินค้าสุทธิ" value="">
                        </div>
                    </div>
                    ...
                    <div class="row gx-4 mb-3 mt-3">
                        <div class="col-md-3 mb-3">
                            <input class="form-control border-warning border rounded" id="inputLastName"
                                type="text" placeholder="รวมต้นทุน" value="">
                        </div>
                    </div>
...
<script>
    flatpickr("#date", {
        locale: "th", // Set Thai Language
        enableTime: true, // Enable time selection
        dateFormat: "d/m/Y H:i" // Adjust date and time format as needed
    });
</script>
