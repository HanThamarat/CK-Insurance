...
<div id="EditDataAssetsModal"
    ...
    <div class="relative bg-white rounded-lg w-full max-w-screen-lg  max-h-screen overflow-auto scrollbar-hidden mt-12 mb-12"
        ...
        <form id="EditDataAssetForm">

            <div class="flex flex-col space-y-4 p-6 mt-[-30px]">
    ...
    $(document).ready(function() {
        $('#submitBtn').click(function(e) {
            ...
            if (!valid) {
                ...
                var formData = new FormData($('#EditDataAssetForm')[0]); // สร้าง FormData จากฟอร์ม
