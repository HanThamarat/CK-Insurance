<div id="showUserModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="flex items-center justify-center w-full h-full">
        <div class="relative bg-white rounded-lg w-full max-w-6xl mx-4 p-6 max-h-[85%] flex flex-col overflow-y-auto scrollbar-hidden">
            <!-- Modal Header -->
            <div id="header" class="top-0 z-10 transition-bg duration-300 bg-white p-2" style="background-color: white;">
                <button class="absolute top-7 right-6 p-1 text-gray-400 hover:text-gray-600 focus:outline-none" onclick="closeShowUserModal()">
                ...
                <div class="flex items-center space-x-3">
                    <img src="{{ asset('img/user.gif') }}" alt="show icon" class="avatar-sm" style="width:50px;height:50px">
                    <div class="flex-grow">
            ...
            <form id="showUserForm" class="mt-[-12] space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="showPassword" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="showBranch" name="branch"
                                class="w-full px-4 py-1.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-400 focus:border-orange-400">
                        ...
                        <div>
                            ...
                            <select id="showStatusUser" name="status_user"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        window.openShowUserModal = (button) => {
            ...
            document.querySelector(`input[name="status"][value="${userStatus}"]`).checked = true; // Set the radio button status
